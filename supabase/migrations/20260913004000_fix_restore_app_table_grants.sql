-- Fix 42501 / PostgREST: exige has_table_privilege(UPDATE) a nivel de tabla.
-- Defensa de columnas sensibles: RLS + triggers (protect_profile_fields, protect_message_fields, protect_task_owner).
