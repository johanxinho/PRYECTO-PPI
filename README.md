...
- [docs/EXPLICACION-EQUIPO-RECORDATE.md](docs/EXPLICACION-EQUIPO-RECORDATE.md): explicación técnica para el equipo de desarrollo (stack, arquitectura, Supabase, flujos, deploy y convenciones).
